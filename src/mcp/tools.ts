...
export const SearchSchema = z.object({
  ...
  airConditioner: z.boolean().optional().describe('Has air conditioning'),
  warehouse: z.boolean().optional().describe('Has storage room/warehouse'),
  accessibility: z.boolean().optional().describe('Wheelchair accessible'),
  furniture: z.boolean().optional().describe('Furnished'),
  renovated: z.boolean().optional().describe('Renovated'),
  bars: z.boolean().optional().describe('Has security bars'),
